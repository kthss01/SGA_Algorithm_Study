...
void InitDirect3D(HINSTANCE hInstance)
{
	...
	//Create VpBuffer
	{
		...
		D3DXMatrixLookAtLH(&VpBufferData.View, &D3DXVECTOR3(0, 0, -1), &D3DXVECTOR3(0, 0, 0), &D3DXVECTOR3(0, 1, 0));
		D3DXMatrixTranspose(&VpBufferData.View, &VpBufferData.View);

		D3DXMatrixOrthoOffCenterLH(&VpBufferData.Projection, 0, (float)Width, 0, (float)Height, -1, 1);
...
WPARAM Running()
{
	...
	while (true)
	{
		...
		else
		{
			...
			D3DXCOLOR background = D3DXCOLOR(0.45f, 0.45f, 0.45f, 1);
